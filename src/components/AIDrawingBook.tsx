  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex-1 flex flex-col min-h-0">
        ...
        {/* Main Content */}
        <main className="flex-1 grid grid-cols-2 lg:grid-cols-4 gap-2 bg-white p-2 rounded-2xl shadow-lg border-4 border-dashed border-blue-600 min-h-0 overflow-hidden"> 
