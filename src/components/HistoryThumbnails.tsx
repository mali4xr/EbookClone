          ...
          {history.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center flex-shrink-0">
              ...
              >
                ...
                <div className=" absolute top-1 w-6 h-6 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-pink-500 text-white font-bold text-sm shadow-lg">
                {idx + 1}
              </div>
